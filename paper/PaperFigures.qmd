...
pcptheme <- ggparallel_options(show_column_names = TRUE, show_bounds_labels = FALSE, show_points = TRUE, show_bounds_rect = FALSE, x_axis_text_angle = 90, x_axis_text_hjust = 0, fontsize_x_axis_text = 14)

figure2pcpa <- ggparallel(drybeans, options = pcptheme, col_colour = "Class", order_observations_by = "original")


figure2pcpb <- ggparallel(drybeans, options=pcptheme, col_colour = "Class", order_observations_by = "original", highlight = "DERMASON")

ggsaves::ggsaves(figure2pcpa, prefix = "figure2pcpa", outfolder = here("paper"), height = 5, width = 12, dpi = 300)
ggsaves::ggsaves(figure2pcpb, prefix = "figure2pcpb", outfolder = here("paper"), height = 5, width = 12, dpi = 300)
```
